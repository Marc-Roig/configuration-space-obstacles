function Polygon() {
    ...
    this.calculateSegments = function() {
        ...
        for (let i = 0; i < this.corners.length; i++) {
            ...
            // let a = 200 //Vertical segments have infinite slope, 1000 its enough for this usage
            if (abs((lastCorner.x) - (firstCorner.x)) > 3) { 
    ...
    // There may be an special case when only ray tracing
    // with a ray trace the point may be outside and the math says otherwise 
    // Solution sugested in alienryderflex:
